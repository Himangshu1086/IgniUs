...
const handleSubmit= async (e)=>{
    ...
    const res =  await fetch(`${baseUrl}/api/CLASS10/apiforclass10post` , {
       ...
       body:JSON.stringify({
        chaptername , name ,  date, coverImage , writerImage ,  title , post , descriptionOfwriter
       }) 
   ...
   if(res2.error){
    ...
    alert(`Article Added in ${chaptername}`)
   }
}
...
const handleSubmittwo = async (e)=>{
    ...
    const resab =  await fetch(`${baseUrl}/api/CLASS10/apiforsubject` , {
       method:"PUT",
       headers:{
        'Content-Type':'application/json'
       },
   ...
   if(resbc.error){
    ...
    alert(`Chapter Added in ${subjectname}`)
   }
}
...
const handleSubmitPOST= async (e)=>{
   ...
   if(res2.error){
    ...
    alert(`Place for writimg article is  Added for ${chaptername}`)
   }
}
    ...
    return(
        ...
        <link rel="stylesheet" href="//netdna.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css"></link>
           ...
           <label className="AskLabel">CREATE ARTICLE FOR CLASS10 :</label>
                <form className="formforask"  >


                <input className="form-control" type="text" placeholder="chapter name"
                    name="chaptername" value={chaptername} required
...
<input  className="form-control"  type="text" placeholder="person image url" 
        ...
        <div className="container"  onSubmit={(e)=>handleSubmittwo(e)}>
           <label className="AskLabel">CREATE CHAPTER FOR CLASS10 :</label>
                <form className="formforask"  >
                ...
                <input className="form-control" type="text" placeholder="chapter name"
                    name="chaptername" value={chaptername} 
                    onChange={(e)=>{setchaptername(e.target.value)}}
                    /><br/>
        ...
        <div className="container" style={{paddingTop:"30px" }} onSubmit={(e)=>handleSubmitPOST(e)}>
           <label className="AskLabel">CREATE PLACE WITH SUBJECTNAME TO CREATE ARTICLE CLASS10 :</label>
                <form className="formforask"  >
