...
const branchList = nitks.map(function(nitk){
    ...
    return(
        ...
        <div   style={{ backgroundImage:`url(https://images.unsplash.com/photo-1607309844132-a3d2aabb289b?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80)` , backgroundSize:"cover" ,paddingTop:"180px", minHeight:"100vh"}}>
