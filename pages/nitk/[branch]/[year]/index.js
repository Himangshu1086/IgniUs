...
const NITK = ({courses})=>{
    ...
    return(
        <div  style={{ backgroundImage:`url(https://images.unsplash.com/photo-1528542071754-091278c27570?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1490&q=80)` , backgroundSize:"cover" ,paddingTop:"240px", minHeight:"100vh"}}>
